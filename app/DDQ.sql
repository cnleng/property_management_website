...
CREATE TABLE tenant (
    ...
    Name VARCHAR(50) NOT NULL, 
    Credit_Score INT, 
    Social_Security INT NOT NULL, Date_Of_Birth DATE NOT NULL, FOREIGN KEY (Property_ID) REFERENCES property (Property_ID) ON DELETE CASCADE, FOREIGN KEY (Lease_ID) REFERENCES lease (Lease_ID) ON DELETE CASCADE);
