...
CREATE TABLE owner (
    Owner_ID INT(1) AUTO_INCREMENT PRIMARY KEY NOT NULL, 
    Number_Of_Properties INT NOT NULL, 
    Name VARCHAR(50) NOT NULL);

DROP TABLE IF EXISTS lease;
CREATE TABLE lease (
    Lease_ID INT(1) AUTO_INCREMENT PRIMARY KEY NOT NULL, 
...
CREATE TABLE property (
    Property_ID INT(1) AUTO_INCREMENT PRIMARY KEY NOT NULL, 
    ...
    Lease_ID INT(1) NOT NULL);

DROP TABLE IF EXISTS tenant;
CREATE TABLE tenant (
    Tenant_ID INT(1) AUTO_INCREMENT PRIMARY KEY NOT NULL, 
...
CREATE TABLE lease_owner (
    lID INT(1) AUTO_INCREMENT PRIMARY KEY NOT NULL, 
...
CREATE TABLE property_owner (
    pID INT(1) AUTO_INCREMENT PRIMARY KEY NOT NULL, 
    Property_ID INT NOT NULL, 
    Owner_ID INT NOT NULL, 
